...
public class PainelExcluirCliente extends JPanel implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if ("Buscar".equals(e.getActionCommand())) {
			...
			int opcao = JOptionPane.showConfirmDialog(this, "Confirmar a exclusão do cliente? Todos os dados, inclusive de sua conta, serão excluídos.", "Confirmação de exclusão", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
			if(opcao == 0) {
